...
public class TreeMap01 {
    public static void main(String[] args) {
        ...
        /*
        1)TreeMap'ler entrySet'leri key'lere göre "natural order"da siralar.
        2)TreeMap'ler en yavas Map'lerdr.
        ...
        salaries.put("Mary Satr", 1000.00);
        salaries.put("Jimmy Jones",5000.00);
        salaries.put("Kevin Bridgeman",6000.00);

        System.out.println(salaries);//{Jimmy Jones=5000.0, Kevin Bridgeman=6000.0, Mary Satr=1000.0, Tom Hanks=3000.0}


        //TAİLmAP() verilen key'den baslayarak sona kadar tum entry'leri size verir.
        SortedMap <String,Double>map1=  salaries.tailMap("Kevin Bridgeman");

        System.out.println(map1);//{Kevin Bridgeman=6000.0, Mary Satr=1000.0, Tom Hanks=3000.0}

        //tailMap(String,false) verilen key'den baslayarak sona kadar tum entrey'leri size verir. ama sizin verdiginiz key'i haric tutar.
