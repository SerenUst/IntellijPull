...
public class StringManipulation01 {
    ...
    public static void main(String[] args) {
       ...
       //lastIndexOf() iki parametre ile kullanilirsa ikinci parametrede verilen sayiyi "index" olarak
        // kabul edip en bastan
        //        // bu indexe kadar olan karakterleri bir kutu icine aliniz ve lastIndexOf() method'unu sadece bu
        //        kutu icindeki String icin kullaniniz.
