    ...
    public class stringBuilder01 {
         ...
         */
           ...
           String str = "Java";
            ...
            strb3.append("Cat");
            strb3.append("x x x x x x x x x x x x x x x");
            ...
            //insert(3, "KLMOPQRSTU", 5, 8); ==> 3. charater'den sonra, "KLMOPQRSTU" String'inin index 5, 6, 7 deki
         // character'lerini yerlestirir
