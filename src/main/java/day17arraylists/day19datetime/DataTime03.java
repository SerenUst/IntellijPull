...
public class DataTime03 {
    public static void main(String[] args) {
        ...
        1)java da sabit dataları (Gun isimler,Ay isimleri,Amerika daki eyalet isimleri etc.) depolamak ve
        gerektiğinde kullanmak için depolar oluştururuz. Bu depolara "Enum" denir.

         */

        //Example 3: USA icin "Woow!" , UK icin "Big", "CANADA" icin "Cold", "TURKEY" icin "Vatan", "GERMANY" icin
        // "Araba", "RWANDA" icin "Cay"yazın.
