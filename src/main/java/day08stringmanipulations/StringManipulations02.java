...
// ex1: Bir stringeki space haric kac tane character kullanıldıgını gosteren kod yazınız
        // "ali okula gitti" ==> 14

        String str = "Ali okula gitti . " ;

        //replace() methodu bir strindeki herhangi bir karakteri veya karakterleri degiştirmek için kullanılır
