...
// 1 . yol ;
     ...
     // Example : 17 den 4 e kadar tum cift sayıları ekrana aynı satırda yazdıran kodu yazınız.
      ...
      //Exaple 4 : Size verilen bir tamsayının rakamalrı toplamını ekrana yazdıran kodu yazınız
