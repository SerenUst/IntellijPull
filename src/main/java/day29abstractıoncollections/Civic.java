...
"concrete method"lar ne yapılacagı ile birlikte nasıl yapılacagını(How to do ) da soyler .

"interface "ler bir yapılacaklar isler listesidir.(To do list)

"multiple parent interface" kullandıgınızda aynı meyhod ismi ile birden fazla method olusturursanız bu methodların
return type leri aynı olmalıdır. Aksi takdirde hata verir.

"interface" lerde constructor olmadıgı için interface'lerden object olusturulmaz.
"abstract class"larda class oldukları için constructor vardır. Ama constructor lar abstract class'larda object
olusturamazlar.
       ...
       2)Variable
              ...
              "Abatract Class"larda normal Class'lardaki gibi her türlü variable olusturulabilir.
              "Interface"lerde ise variable'lar public static ve final olmak zorundadır.,

       3)Inheritance

               "Abstract Class"larda class oldukları için multiple ınherotance'a musade etmezler.
       ...
       4)Object Creation
        ...
        soru: Object Oriented Programming Language prensipleri nelerdir? oop presıpıl ingcesi
